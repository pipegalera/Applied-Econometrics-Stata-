...
outreg2 using "results/Results4a.dta", replace ctitle(Model1) label: ///
reg demp nj, robust

outreg2 using "results/Results4b.dta", replace ctitle(Model1) label: ///
reg demp $x, robust

preserve
use "results/Results4b.dta", clear
